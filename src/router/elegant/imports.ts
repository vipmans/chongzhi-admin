...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  complaints_list: () => import("@/views/complaints/list/index.vue"),
  ...
  "ops_audit-logs": () => import("@/views/ops/audit-logs/index.vue"),
  ops_jobs: () => import("@/views/ops/jobs/index.vue"),
  "ops_login-logs": () => import("@/views/ops/login-logs/index.vue"),
  "ops_mobile-segments": () => import("@/views/ops/mobile-segments/index.vue"),
  ...
  suppliers_detail: () => import("@/views/suppliers/detail/[id].vue"),
